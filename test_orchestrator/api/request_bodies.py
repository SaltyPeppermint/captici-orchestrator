...
class TestRequest(BaseModel):
    n_commits: int = Field(None, description="n commits to test", gt=0),
    n_configs: int = Field(None, description="n configs to test", gt=0),
    first_commit_hash: str = Field(None,
                                   description="SHA1 Hash of the first commit to test.",
                                   min_length=40, max_length=40, regex=r"[0-9A-Fa-f]+"),
    last_commit_hash: str = Field(None,
                                  description="SHA1 Hash of the first commit to test.",
                                  min_length=40, max_length=40, regex=r"[0-9A-Fa-f]+"),
